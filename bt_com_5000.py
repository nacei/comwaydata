...
# represent the data and sent to  web port 5000 in wh server http://101.132.169.233:5000/hhdata
# python 3.x
...
def http_post(postdata):
    ...
    url = "http://101.132.169.233:5000/hhdata"  # sent to whuhan server for wh
